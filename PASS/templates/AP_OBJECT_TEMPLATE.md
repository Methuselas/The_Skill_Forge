...
## Objective
<The outcome this procedure produces.>

## Steps / Flow
1. <ordered domain action>
2. <ordered domain action>

## Notes
<Source-derived context. No PASS extraction/validation/ledger steps here.>
