...
# Develop a College Admission Essay Topic from Life Material

## Objective
Move from an apparently empty or undifferentiated life history to a truthful, specific college admission essay topic whose story and interpretation answer the live prompt and reveal applicant meaning the rest of the application does not supply.
...
2. **Build a broad life-material pool.** Activate the autobiographical reconstruction variant of `writing_collect_fragments_before_demanding_complete_draft`. Gather milestones and ordinary moments across several ages, consult personal records and informed witnesses, and mark turning points, repeated situations, and surprising differences. Preserve recollections as material to examine rather than facts certified by repetition.
...
4. **Explore promising seeds.** Choose a memory, relation, activity, question, or aspect of self with live pressure and activate `writing_freewrite_to_discover_what_draft_is_about`. Reread and mark details, insights, questions, and productive digressions. If nothing gains specificity or meaning, return to the pool and freewrite from a different seed.
