...
# Prepare Referees Before Submission

## Pattern Rule
**IF** an application may advance to reference checking
**THEN** secure permission from credible work-related referees, verify their current details, and control when their contact information is disclosed
...
## Notes
Reference readiness begins before names are requested. Permission protects the relationship, while a current briefing helps a referee connect remembered performance to the role under consideration. Deferring contact details is useful when privacy matters, but it must yield to explicit application requirements.
