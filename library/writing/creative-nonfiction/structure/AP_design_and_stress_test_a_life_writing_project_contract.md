...
4. **Set the truth contract and evidence architecture.** Activate `writing_creative_nonfiction_preserve_factual_accountability_while_using_literary_craft`. Inventory direct memory, observation, interviews, records, correspondence, artifacts, prior accounts, inference, reconstruction, dispute, and unknowns. Then activate `writing_creative_nonfiction_verify_checkable_facts_and_research_necessary_context` to test source quality, archive asymmetry, missing voices, and research tasks. Define how speculation and reconstruction will be signaled. **Evidence gate:** central claims have supportable routes, and no structural promise depends on an absence being filled by invention.
