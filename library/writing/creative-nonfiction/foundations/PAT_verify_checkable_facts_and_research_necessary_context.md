...
## Pattern Rule
**IF** a creative nonfiction draft makes provable claims or lacks factual context needed for readers to understand and trust its inquiry
**THEN** verify every consequential checkable assertion, investigate the missing context, and shape only the necessary findings into the essay
**ELSE** stop collecting information when further research would neither correct a claim nor deepen the work's active question
...
## Don't
- Let a readily correctable mistake damage confidence in claims that were researched carefully.
...
## Checklist
- Every claim that can materially be proved or disproved has been checked against a suitable source or observation.
