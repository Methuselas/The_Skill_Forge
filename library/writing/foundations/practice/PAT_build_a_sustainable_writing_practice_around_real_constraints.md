...
# Build a Sustainable Writing Practice Around Real Constraints

## Pattern Rule
**IF** writing occurs only when inspiration, abundant time, or ideal conditions happen to coincide
**THEN** establish a small recurring practice contract fitted to actual obligations, attention, place, and energy, then adjust it from observed sessions
**ELSE** preserve the routine that reliably produces material and revise it only when circumstances or results change
...
- Let longer sessions grow from available capacity without making their duration the minimum required for the practice to count.
