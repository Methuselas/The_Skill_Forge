...
# Recover from Writing Block by Lowering the Hurdle

## Pattern Rule
**IF** a writing task stalls because its scope, quality expectations, or demand for immediate correctness makes beginning feel unsafe or unmanageable
**THEN** lower the current hurdle to a bounded low-stakes drafting target, then keep producing material without judging it by finished-work standards
**ELSE** diagnose the obstacle by explaining aloud what you are trying to make and why it feels difficult
...
- If the smaller scope did not help, the obstacle can now be named more precisely after being explained aloud.
