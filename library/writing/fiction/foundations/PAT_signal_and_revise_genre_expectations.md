...
references: []
variants:
  - variant_id: writing_fiction_variant_seed_secondary_genre_expectation_without_converting_whole_story
    variant_name: Seed a Secondary Genre Expectation Without Converting the Whole Story
    variant_basis: context
    difference_from_foundation: Introduce a limited cue from a secondary genre to create a useful line of anticipation while keeping the primary story's governing action, tone, and promised experience intact.
    when_to_use: A crime, romance, speculative, horror, comic, or other secondary expectation can intensify curiosity, uncertainty, or interpretation without becoming the story's main contract.
    when_not_to_use: The secondary signal dominates the opening, promises an experience the story never addresses, or functions only as a false alarm with no effect on character or meaning.
    absorbed_from_object_id: none
---

# Signal and Revise Genre Expectations

## Pattern Rule
**IF** a fiction draft accidentally promises the wrong kind of story or reproduces a genre so mechanically that its particulars feel borrowed
**THEN** coordinate selected cues in situation, setting, voice, language, structure, and anticipated experience so readers can recognize the intended contract while the story remains specific
**ELSE** preserve mixed or unfamiliar signals when their interaction creates a deliberate and intelligible promise
