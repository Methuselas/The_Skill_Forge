...
# Orient Speakers with Unobtrusive Formatting and Tags

## Pattern Rule
**IF** readers must stop to untangle who said a line or notice the attribution more than the remark
**THEN** give each speaker a new paragraph, establish the turn order, and use the least conspicuous correct tag or action beat needed to keep identity clear
