...
# Transform Real People into Composite Characters

## Pattern Rule
**IF** a fictional character begins from the writer, an acquaintance, or another identifiable person
**THEN** retain telling observed particulars while recombining traits, histories, motives, and inventions into a character answerable to the story rather than to biographical fidelity
**ELSE** use wholly invented material, but give it the same density of specific behavior
