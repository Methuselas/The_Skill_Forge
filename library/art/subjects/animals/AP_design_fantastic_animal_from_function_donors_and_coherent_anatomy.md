---
object_id: AP_design_fantastic_animal_from_function_donors_and_coherent_anatomy
object_type: ap
name: Design a Fantastic Animal From Function, Donors, and Coherent Anatomy
library_path:
- art
- subjects
- animals
...
# Design a Fantastic Animal From Function, Donors, and Coherent Anatomy

## Objective
Design a fantastic or science-fiction animal whose invented anatomy reads as one coherent organism, supports its intended function and action, remains novel through transformed relationships rather than accumulated parts, and survives pose testing before rendering.

## Steps / Flow
1. **Define what the creature must communicate or do.** Start from role, locomotion, ecology-like task, expressive character, or narrative function. When the premise itself is open, delegate concept search to `AP_generate_visual_concepts_from_purpose_driven_questionnaire` and resume with selected candidates.
...
## Notes
Persistent invariants are function, unity, force continuity, identity before ornament, novelty through transformed relationships, and testability across more than one convenient static pose. This AP treats donor anatomy as design evidence, not as species authority.
