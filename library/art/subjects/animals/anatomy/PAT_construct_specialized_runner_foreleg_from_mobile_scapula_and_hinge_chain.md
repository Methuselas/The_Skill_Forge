---
object_id: PAT_construct_specialized_runner_foreleg_from_mobile_scapula_and_hinge_chain
object_type: pattern
name: Construct a Specialized Runner Foreleg From a Mobile Scapula and Hinge-Dominant Chain
library_path:
- art
- subjects
- animals
...
# Construct a Specialized Runner Foreleg From a Mobile Scapula and Hinge-Dominant Chain

## Pattern Rule
**IF** a horse or comparable ungulate runner foreleg is being built as a generic vertical leg, a fixed shoulder socket, or a mirror of the hindleg
**THEN** place the scapula as a slanted mobile blade riding on the side of the thorax, connect the humerus through the shoulder joint, then carry the limb through the elbow, forearm, carpus, elongated metacarpal region, and distal digits as one fore-aft support-and-swing chain whose exact proportions and joint forms come from the animal being studied
...
## Checklist
- The foreleg begins from a mobile scapular support rather than a fictional chest socket.
- Scapula, humerus, elbow, forearm, carpus, metacarpal region, and distal foot can be traced as one ordered chain.
- A change in scapular position changes the reach and organization of the whole limb rather than leaving the shoulder frozen.
- The runner-specific distal simplification is visible without being copied into unrelated animal types.
- Skeletal landmarks support the living contour, but the construction still reads before those landmarks are emphasized.
- Segment lengths, joint directions, and three-dimensional axes agree with the observed animal and view.

## Notes
Bammes opens Chapter 6 by contrasting forelimb specializations: climbing cats retain more forearm rotation, runners sacrifice that freedom for a more restricted support-and-swing apparatus, and primates develop a much wider range of shoulder, arm, and hand movement. Section 6.1 then develops the ungulate runner as a specific construction problem rather than as a generic mammalian foreleg.

His Figure 68 makes the shoulder-to-foot chain explicit. The scapula is a mobile triangular plate suspended against the thorax; the humerus and forearm continue the pendulum; the carpal, metacarpal, and digital regions become increasingly spare and mechanically constrained. Figure 69 then shows why the scapula cannot be treated as a fixed surface landmark: a small shift at the shoulder girdle prepares a much larger change in the position of the foot.
