---
object_id: DRILL_map_pure_trunk_muscle_actions_from_spinal_axes
object_type: drill
name: Map Pure Trunk Muscle Actions From Spinal Axes
library_path:
- art
- subjects
- animals
...
foundation_object_id: PAT_read_animal_trunk_muscles_from_spinal_axes_and_levers
tags:
- animal_drawing
- animal_anatomy
- trunk
...
confidence: high
target_skill: reducing the pure trunk musculature to a cross-section and broad pull-system map that predicts flexion, extension,
  lateral bending, and torsion from the muscles' positions around the spinal axes
references: []
variants: []
---

# Map Pure Trunk Muscle Actions From Spinal Axes

## Practice Task
Make a cross-section plus side-view study of the pure trunk muscles in which every major mass is placed from the spinal axes first and can be used to predict one of four trunk actions: flexion, extension, lateral bending, or torsion.
...
## Success Check
- All four actions are predicted from muscle position relative to a spinal axis rather than from memorized labels.
- The dorsal extensor, ventral rectus, and diagonal external-oblique routes remain legible as broad functional masses around the abdominal cavity.
- The pelvis/sacrum anchor and spinal-process/rib lever relationships survive simplification.
- Dog and horse studies preserve the same mechanical logic without becoming identical silhouettes.
