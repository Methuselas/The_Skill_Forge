...
10. **Advance without abandoning the dependency solution.** Stage 3 may make the construction more specific and Drawing Stage 4 may integrate final pencil line/value, but later work must preserve the Stage 2 action, support, attachments, and major spatial relations unless the workflow explicitly rolls back. Color and other medium finish remain downstream.
