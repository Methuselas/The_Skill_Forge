...
4. **Preserve the motion logic while correcting structure.** As each drawing is clarified, compare it with relevant preceding and following states. Keep arcs, overlaps, squash and stretch, directional changes, and connected secondary actions consistent with where each shape came from and where it is going.
