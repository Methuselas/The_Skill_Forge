...
4. **Design one clear action or gesture at a time.** Keep the primary statement simple and coordinate the whole body around it. Let secondary actions support the current idea rather than compete with it.
