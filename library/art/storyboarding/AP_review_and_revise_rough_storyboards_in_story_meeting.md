---
object_id: AP_review_and_revise_rough_storyboards_in_story_meeting
object_type: ap
name: Review and Revise Rough Storyboards in a Story Meeting Before Production
library_path:
- art
- storyboarding
...
# Review and Revise Rough Storyboards in a Story Meeting Before Production

## Objective
Use a story meeting to test a rough storyboard while its drawings and directing choices are still cheap to change, so the group diagnoses the actual dramatic problem before the sequence hardens into production.
...
7. **Correct the diagnosis before correcting the board.** When discussion shows that the assumed problem was false or mislocated, discard the proposed fix and restate the actual problem. Do not improve a board toward the wrong diagnosis.
8. **Make only revisions that strengthen the sequence.** Add, remove, reorder, or redraw panels when the change clarifies conflict, character, information, subtext, acting, or progression. Do not accumulate sketches merely because ideas were suggested in the room.
