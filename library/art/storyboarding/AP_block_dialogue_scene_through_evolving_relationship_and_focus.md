---
object_id: AP_block_dialogue_scene_through_evolving_relationship_and_focus
object_type: ap
name: Block Dialogue Scene Through Evolving Relationship and Focus
library_path:
- art
- storyboarding
...
# Block Dialogue Scene Through Evolving Relationship and Focus

## Objective
Turn a dialogue scene into an evolving visual relationship by coordinating blocking, physical business, shot choice, conceal/reveal, and focal emphasis so the characters' objectives and changing power dynamic remain readable even when the spoken words are temporarily ignored.
