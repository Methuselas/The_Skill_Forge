...
- variant_id: VAR_gurney_ground_color_script_in_observed_daylight_sequence
  ...
  difference_from_foundation: Uses a compact observational run across a real day as evidence for how large color
    masses and illumination states change before those relationships are compressed or transformed into a designed
    narrative script.
