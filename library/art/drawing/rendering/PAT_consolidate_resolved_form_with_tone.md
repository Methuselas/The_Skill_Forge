...
- variant_id: VAR_guptill_simplify_diffuse_multisource_values_then_restore_reflective_accents
  ...
  when_to_use: Use when an interior, still life, or other multisource scene is becoming fussy and fragmented from copying every
    small value change, or when broad simplification has gone so far that reflective material and key structural accents disappear.
