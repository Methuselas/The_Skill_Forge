---
object_id: AP_develop_product_concept_from_search_sketch_to_communicable_design
object_type: ap
name: Develop a Product Concept From Search Sketch to Communicable Design
library_path:
- art
- drawing
- sketching
...
- rel: supports
  target_object_id: PAT_match_sketch_resolution_to_design_role_and_audience
- rel: supports
  target_object_id: PAT_search_product_silhouette_in_profile_before_volumetric_development
- rel: supports
...
# Develop a Product Concept From Search Sketch to Communicable Design

## Objective
Develop a product concept only as far as the active design question and audience require, preserving the character of the selected seed while establishing coherent spatial form, consistent views or states, and enough communication to evaluate the design without disguising unsupported engineering behind polish.
...
## Notes
The persistent invariants are question, character, volume, identity, evidence, and resolution. The protocol deliberately separates visual plausibility from engineering/manufacturing validity because the Art library does not own every technical constraint a real product would require.
