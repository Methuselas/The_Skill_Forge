...
`VAR_bridgman_amplify_arm_sweep_through_shoulder_girdle` retains **Amplify Arm Sweep Through the Moving Shoulder Girdle** as a bounded alternative; use it only under the conditions recorded in the variant metadata.
