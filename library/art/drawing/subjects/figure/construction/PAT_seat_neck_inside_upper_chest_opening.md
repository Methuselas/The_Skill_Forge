...
- variant_id: VAR_mogilevtsev_read_collar_as_evidence_of_neck_root_insertion
  ...
  when_not_to_use: Do not assume every collar maps the anatomy literally. Loose, stiff, padded, high, or otherwise structured garments can obscure or redirect the cues; use the observed cloth as evidence, not as an anatomical tracing device.
  absorbed_from_object_id: none
