...
- Taper the organic cylinder where the adjoining knee, wrist, ankle, or other form requires a narrower end.
...
- Treat the geometric cylinder as finished anatomy; it is a Stage 2 carrier for the later organic form.
...
- Stage 3 anatomy can occupy the cylinder without contradicting its perspective.

## Notes
Hogarth's cylinder is a rational simplification, not a compulsory visible scaffold. The dark construction in the thigh demonstration proves that the Stage 2 mass can carry the later leg. When the organic form will not fit, the construction must be corrected rather than concealed.
