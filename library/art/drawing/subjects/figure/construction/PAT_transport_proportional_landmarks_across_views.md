...
## Pattern Rule
**IF** a difficult figure orientation cannot be placed confidently in depth but the same action can be solved in a clearer view
**THEN** establish corresponding proportional landmarks in the clear view, project those relationships into the target orientation, and rebuild the target figure from known forms
...
- Reconstruct volume at the destination with the established figure-construction rules.
...
- Local corrections do not contradict the transported whole-figure relationships.
