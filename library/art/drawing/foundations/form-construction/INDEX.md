...
- [Integrate the Shoulder Mass With the Rib Cage](PAT_integrate_shoulder_mass_with_rib_cage.md) - pattern; 2 block.
  - Variants: `Amplify Arm Sweep Through the Moving Shoulder Girdle` (method_sequence); `Block the Shoulder Girdle as an Independent Perspective Bridge` (method_sequence).
...
- [Project Form Curves From the Camera View](PAT_project_form_curves_from_camera_view.md) - pattern; 3 rough.
  - Variants: `Make Every Added Line Obey the Surface Form` (method_sequence); `Square Organic Masses, Solve the View, Then Round Them Back` (method_sequence).
...
- [Transport Proportional Landmarks Across Views](PAT_transport_proportional_landmarks_across_views.md) - pattern; 2 block.
  - Variants: `Reverse Projection Between Corresponding Views` (method_sequence).
- [Turn Cylinder End Curves With Depth](PAT_turn_cylinder_end_curves_with_depth.md) - pattern; 2 block.
  - Variants: `Set the Cylinder Axis Before Its End Ellipses` (method_sequence).
