...
`VAR_bammes_group_muscles_by_joint_axis_and_pull_direction` retains **Group Muscles by Joint Axis and Pull Direction** as a bounded alternative; use it only under the conditions recorded in the variant metadata.
