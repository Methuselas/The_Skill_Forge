...
- [Select Observed Evidence to Serve Expressive Intent](PAT_select_observed_evidence_to_serve_expressive_intent.md) - pattern; 0 design.
  - Variants: `Force Selection With a Two-Value Brush Constraint` (constraint).
