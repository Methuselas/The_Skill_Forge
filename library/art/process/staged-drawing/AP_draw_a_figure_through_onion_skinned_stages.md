...
2. **Stage 0 — choose the picture.** Use the single universal low-information Stage 0 ceiling. When composition is open, use one four-candidate contact sheet. Search camera, crop, major placement/scale, dominant action read, negative space, hierarchy, broad value/light, and story without developed anatomy, materials, color finish, or presentation rendering.
...
11. **Stage 4 — finish the pencils.** Apply `PAT_preserve_structure_during_stage4_pencil_finish`. Carry Stage 0 as root and approved Stage 3 as immediate anchor. Clean construction residue, resolve final pencil contours, establish line hierarchy, clarify focal contacts/anatomy, and integrate selective graphite value without redesign or entering Ink/Color/Paint.
