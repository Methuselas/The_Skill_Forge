...
- Do not use the old staged figure, dragon, alien, **observatory contact sheet**, or any other multi-panel process board as a productive Stage 0 artifact-form authority. Their continuity/search lessons may survive as history, but their process-sheet form is superseded for current Drawing calibration.
