...
8. **Pass the transfer gate.** Identify exactly which information must survive into the rendering base: visible structural contours, necessary internal boundaries, important form-light guides, and required cast-shadow geometry. Remove scaffolding whose diagnostic job is finished.
