...
4. **Lock the light model.** Establish the dominant illumination and large light/shadow relationships before local color becomes authoritative.
...
8. **Develop color inside the accepted structure.** Preserve large value families while adding intentional hue, chroma, and temperature variation within them.
...
11. **Resolve edge and focal hierarchy.** Reconcile near/far edge behavior, focal accents, contrast, and selective finish against the whole image.
