---
object_id: PAT_intensify_distinguishing_characteristics_without_losing_structure
object_type: pattern
name: Intensify Distinguishing Characteristics Without Losing Structure
library_path:
- art
- foundations
- observation
...
- variant_id: VAR_marvel_exaggerate_role_defining_character_structure
  ...
  difference_from_foundation: Selectively pushes structural traits that carry a comics character's intended role—such as shoulder
    and chest breadth, limb mass, hand or foot scale, stance spread, and head-to-body ratio—while retaining coherent construction,
    balance, and identity.
  when_to_use: Use when a character should read as more heroic, imposing, squat, bulky, powerful, or otherwise role-specific
    without becoming indiscriminately distorted.
...
## Pattern Rule
**IF** stronger identity or expressive character is wanted after the subject's main relationships are understood
**THEN** identify the few proportional or shape characteristics that distinguish this subject and selectively push those relationships while preserving the structural system that makes the subject coherent
**ELSE** retain observed proportions when accuracy or neutral description is the governing objective

## Do
- Name the specific characteristic before exaggerating it: rounder, bonier, longer, heavier, more angular, narrower, or another observed tendency.
