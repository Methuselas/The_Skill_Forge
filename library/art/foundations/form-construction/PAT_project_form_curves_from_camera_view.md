...
- Make every later contour, cross-contour, anatomical edge, and attachment inherit the same surface turn and camera logic; a line added for anatomy is not exempt from the parent form.
...
- Added contour or anatomy lines reinforce the established surface orientation instead of flattening or contradicting it.
