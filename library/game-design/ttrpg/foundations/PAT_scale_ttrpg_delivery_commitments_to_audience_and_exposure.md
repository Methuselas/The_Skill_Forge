---
object_id: GAME_TTRPG_003
object_type: pattern
name: Scale TTRPG Delivery Commitments to Audience and Exposure
...
tags: [ttrpg, project-scoping, audience, publication, accessibility]
cross_links:
  - rel: related_to
    target_object_id: GAME_TTRPG_001
  - rel: related_to
    target_object_id: GAME_TTRPG_002
reference:
...
# Scale TTRPG Delivery Commitments to Audience and Exposure

## Pattern Rule
**IF** deciding how far a TTRPG project will travel beyond its designer's table
**THEN** match its clarity, safety communication, production effort, and financial exposure to the people who must use it without the designer present.
**ELSE** keep the project explicitly table-supported and avoid promising a self-contained product.
...
## Don't
- Assume a friends-facing draft is ready for unknown players because its designer can answer questions live.
- Call a game welcoming by making its premise vague or by concealing potentially troubling content.
