---
object_id: PAT_translate_genre_into_play_requirements
object_type: pattern
name: Translate Genre into Play Requirements
library_path:
- game-design
- foundations
...
# Translate Genre into Play Requirements

## Pattern Rule
**IF** a game adopts a recognizable genre or subgenre
**THEN** identify the player experience and recurring behaviors that make that genre function, and align character capabilities, mechanics, stakes, resources, world assumptions, and encounter structures with those requirements
**ELSE** avoid using genre labels as promises the design does not intend to fulfill.

## Do
- Identify what players expect to feel and do in the genre, not only what imagery, terminology, or setting elements they expect to see.
...
- Market a play experience that the rules do not reliably produce.
- Treat lore alone or mechanics alone as sufficient communication when the other is necessary to understand the game's actual appeal.

## Checklist
- The genre can be described in terms of play requirements rather than only motifs or aesthetics.
- Major mechanics and resource pressures support those requirements.
...
External communication is downstream of the design promise: show the world, explain the play, and state the meaningful difference. Promotion cannot repair a mismatch between the advertised experience and the behavior the rules actually produce.
