...
12. **Measure the coverage instead of estimating it.** Programmers put their own coverage at about ninety-five percent and typically achieve fifty to sixty. Aim past statement coverage at branch coverage, with every predicate term exercised both ways, and let a tool tell you rather than your impression.
