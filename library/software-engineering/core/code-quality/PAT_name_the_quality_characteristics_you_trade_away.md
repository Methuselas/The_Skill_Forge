...
- Put the *level* of quality into the requirements, and get it from the people who will live with the system rather than setting it yourself. How good this has to be is their trade-off to make: many users would rather have something with rough edges now than something polished a year from now, and that is a legitimate answer you are not entitled to overrule by polishing.
- Know when to stop. Over-refinement spoils finished work the way layer upon layer of detail loses a painting in the paint — and unlike under-delivery, nobody flags it, because it looks like diligence.
