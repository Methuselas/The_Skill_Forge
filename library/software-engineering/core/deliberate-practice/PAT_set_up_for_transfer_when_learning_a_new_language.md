...
- When the goal is to broaden how you think rather than to ship, pick a language fundamentally unlike the ones you have. Moving from one nearby language to another is a false broadening — the image is going from "country music" to "Western music."
...
The pessimistic half is load-bearing rather than discouraging. Far transfer, between genuinely distant domains, is unlikely to happen spontaneously, so expect to learn substantial new syntax and new strategies before regaining your previous level. Practices shift too: much of what you know about reuse and abstraction in JavaScript has to be reconsidered in SQL.
