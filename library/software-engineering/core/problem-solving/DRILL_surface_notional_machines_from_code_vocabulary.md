...
## Instructions
1. Collect ten phrases from real discussion that describe code in physical or agentive terms, quoting each as it was actually written rather than recalling it. These examples are the calibration set: a variable "holds" a value, a file is "open" or "closed," a pointer "points" to something, a function "returns" a value, and a function is "called."
...
- Stopping at "it's just a figure of speech." The point is that these figures of speech shape reasoning and have already shaped the languages themselves.
...
## Notes
This is Hermans's exercise — list examples of language used about programming that indicate a notional machine and lead to a certain mental model — expanded into a repeatable pass over real team artifacts rather than a one-time recall task.
