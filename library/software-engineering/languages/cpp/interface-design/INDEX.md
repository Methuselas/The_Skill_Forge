...
- [Declare Single-Argument Constructors Explicit](PAT_declare_single_argument_constructors_explicit.md) - pattern; 2 block. Tags: class_design, cpp, explicit, interface_design, type_conversion.
