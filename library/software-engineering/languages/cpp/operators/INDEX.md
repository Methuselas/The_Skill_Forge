...
- [Leave the Address-of Operator Alone](PAT_leave_the_address_of_operator_alone.md) - pattern; 2 block. Tags: api_design, cpp, generic_programming, operators, wrappers.
