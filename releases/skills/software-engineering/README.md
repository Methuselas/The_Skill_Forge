...
Engineering judgment for design, implementation, review, refactoring and testing, written language-agnostically in `core` with a C++ language module on top. Includes the Code Apprenticeship runner for studying real human-written code.
...
| Domain cards | 553 Patterns, 32 Action Protocols, 71 Drills |
| Modules | `software-engineering/core`, `software-engineering/languages/cpp` |
...
| ZIP | `SkillForge-Software-Engineering.zip`, 2,092,842 bytes |
| SHA-256 | `868f713c90546d509d758df736687d288717d9ed638b2730d307ad1490589a03` |
...
Ask for design, implementation, review, refactoring, testing or C++ help; the skill routes to the few cards the task needs.
